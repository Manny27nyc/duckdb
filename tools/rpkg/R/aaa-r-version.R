...
#
# This file is sourced manually in ./configure (when DUCKDB_R_DEBUG is set),
# and also sourced when the package is loaded.
# - For a package installed in the user library, nothing happens,
#   because the src directory doesn't exist.
